...
1. **Fork** 이 저장소를 포크하세요
2. **Branch** 새로운 기능 브랜치를 만드세요 (`git checkout -b feature/AmazingFeature`)
...
ROKEY 부트캠프 최종 프로젝트의 일환으로 제작되었습니다.
...
| 역할            | 이름 | GitHub                                 |
| --------------- | ---- | -------------------------------------- |
| 🏗️ **팀장**     | -    | [@Kiloc97](https://github.com/Kiloc97) |
| 🤖 **로보틱스** | -    | -                                      |
| 🧠 **AI/ML**    | -    | -                                      |
| 💻 **시스템**   | -    | -                                      |
...
[![Star History Chart](https://api.star-history.com/svg?repos=Kiloc97/Rokey_Last-Mile&type=Date)](https://star-history.com/#Kiloc97/Rokey_Last-Mile&Date)
